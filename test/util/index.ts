...
export function toEqual(wrapper: unknown, value: unknown) {
  expect(wrapper).toEqual(value)
}

export function toContain(wrapper: unknown, value: unknown) {
  expect(wrapper).toContain(value)
}

export function toBe(wrapper: unknown, value: unknown) {
  expect(wrapper).toContain(value)
}
